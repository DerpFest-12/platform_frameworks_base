...
constructor(
    ...
    private fun createAndAddLabels() {
        labelContainer = LayoutInflater.from(context)
            .inflate(if (isRoundQS()) R.layout.qs_tile_label_round else R.layout.qs_tile_label, this, false)
    ...
    private fun createAndAddSideView() {
        sideView = LayoutInflater.from(context)
            .inflate(if (isRoundQS()) R.layout.qs_tile_side_icon_round else R.layout.qs_tile_side_icon, this, false)
                as ViewGroup
    ...
    private fun createTileBackground(): Drawable {
        qsTileBackground =
            if (isRoundQS()) {
                mContext.getDrawable(R.drawable.qs_tile_background_no_mask)?.mutate() as RippleDrawable
